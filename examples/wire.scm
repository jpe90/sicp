(define-module (sicp examples wire)
  #:use-module (sicp examples queue)
  #:export (propagate))

(define (make-time-segment time queue) (pk (cons time queue)))
...
(define (add-to-agenda! time action agenda)
  ...
  (define (add-to-segments! segments)
    (if (= (segment-time (car segments)) time) (insert-queue! (segment-queue (car segments))
                                                              action)
...
(define (probe name wire)
  (add-action! wire
               (lambda ()
                 (newline)
                 (display name) (display " ") (display (current-time the-agenda)) (display " New-value = ")
